...
fetch_asset "https://openaievalsetub0ktk.blob.core.windows.net/assets/SolidWorks/8_mouse_wheel/tests/task/prompt/input.SLDPRT" "e226dd063df80aa5bf70526824c1e85cf7c27e97a42aa6e7be1741bce0e99c93" "/tests/task/prompt/input.SLDPRT"
 2>/dev/null || true
exit 1
